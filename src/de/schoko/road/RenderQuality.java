...
public enum RenderQuality {
	BASIC("Basic", "The ugliest option. Lots of bugs.", 0.5, 0, false),
	FAST("Fast", "Also fast but still with bugs", 0.25, 150, false),
	NORMAL("Normal", "The expected quality. Might have bugs", 0.05, 300, false),
	HIGH("High", "The normal without any bugs.", 0.05, 300, true),
